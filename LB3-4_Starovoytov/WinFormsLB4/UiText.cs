...
{
    /// <summary>
    /// Текстовые константы пользовательского интерфейса (сообщения, заголовки, подписи).
    /// </summary>
    internal static class UiText
    {
        ...
        public const string SelectRowToDelete = "Выберите строку для удаления.";
        public const string ConfirmClearList = "Очистить список расчётов?";
        ...
        public const string StrategyPercentUi = "Процентная стратегия";
        public const string StrategyCertificateUi = "Стратегия сертификат";

        public const string LabelPercentValue = "Процент скидки (%):";
        public const string LabelCertificateValue = "Сумма сертификата:";

        public const string FieldPurchaseAmount = "Сумма покупки";
        public const string FieldDiscountValue = "Величина скидки";
